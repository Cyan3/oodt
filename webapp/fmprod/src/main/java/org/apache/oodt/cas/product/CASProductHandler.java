...
public class CASProductHandler implements LargeProductQueryHandler {
    ...
    public CASProductHandler() throws MalformedURLException,
            ConnectionException {
        this.fm = FactoryClient.createClient(new URL(System.getProperty("fm.url", "http://localhost:9000")));
                //new XmlRpcFileManagerClient(new URL(System.getProperty("fm.url", "http://localhost:9000")));
    }
