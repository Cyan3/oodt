...
/**
 * Created by radu on 7/6/15.
 */
public class AvroLocalDataTransferer implements DataTransfer{
    ...
    /* file manager client */
    private AvroFileManagerClient client = null;
     ...
     * </p>
     */
    public AvroLocalDataTransferer() {
    }
    ...
    public void setFileManagerUrl(URL url) {
        try {
            client = new AvroFileManagerClient(url);
