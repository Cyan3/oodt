...
public class AvroTypeFactory {
    ...
    // Nu-mi trebuie
    public static AvroMimeType getAvroMimeType(MimeType mimeType){
        return new AvroMimeType(mimeType.getName());
    }

    public static MimeType getMimeType(AvroMimeType avroMimeType){
        return null;
    }
    ...
    public static AvroReference getAvroReference(Reference reference){
        ...
        avroReference.setDataStoreReference(reference.getDataStoreReference() != null
                ? reference.getDataStoreReference() : "");
        avroReference.setFileSize(reference.getFileSize());
        if(reference.getMimeType() != null)
            avroReference.setMimeType(AvroTypeFactory.getAvroMimeType(reference.getMimeType()));
    ...
    public static Reference getReference(AvroReference avroReference) {
        ...
        if (avroReference.getMimeType() != null)
            reference.setMimeType(avroReference.getMimeType().getTypeName());
